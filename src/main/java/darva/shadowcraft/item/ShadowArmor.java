...
public class ShadowArmor extends ItemArmor{
	...
	public void setupNBT(ItemStack par1ItemStack)
	{
		...
		par1ItemStack.stackTagCompound.setTag("display", tag);
		
	}
	public ShadowArmor(ArmorMaterial mat, int par3, int par4) {
		super(mat, par3, par4);
	...
	public String getUnlocalizedName() {
		return "shadowcraft:shadowcloak";
	}

	@Override
	public void registerIcons(IIconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("shadowcraft:shadowcloak"); //Temporary.
	}
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
		...
		if (entity.isInvisible()) //If player is invisible, armor should be too.
			return "shadowcraft:textures/armor/blank.png";
		else
			return "shadowcraft:textures/armor/shadowcloak2.png";
	}
