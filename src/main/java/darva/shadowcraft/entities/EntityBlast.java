...
public class EntityBlast extends EntityThrowable {
	...
	public void onEntityUpdate() {
		...
		if (rnd.nextInt(10) > 2)
		{
			...
			setBlock(this.worldObj,x-1,y,z, 1);
			setBlock(this.worldObj,x,y+1,z, 0);
	...
	{
		if (world.isAirBlock(x, y, z) && world.getBlock(x, y, z) != Main.shadowBlock)
		{
			//Possible, and sane to replace this block with shadows.
			world.setBlock(x, y, z, Main.shadowBlock, meta, 1|2);
			world.scheduleBlockUpdate(x, y, z, Main.shadowBlock, 5);
		}
	}
    ...
    protected void onImpact(MovingObjectPosition mop)
    {
        ...
        if (mop.entityHit != null)
        {
			...
			if (armor == null || !(armor.getItem() instanceof ShadowArmor))
